...
```
You can do 350 iterations ahve a look and then do another 150:
...
```
You can add new data points to an existing tSNE. For example you can add where the average of each species lies:
...
```
The filled points show the averages.
